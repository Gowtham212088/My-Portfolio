          ...
          <div className="about-me container">
                  ...
                  <div className="col-lg-6">
                    <ul>
                      <li>
                        ...
                        <span>Gowtham Kumar V</span>
                      </li>
                      <li>
                        <strong>
                          <span style={{ color: "#18d26e" }}>➤ </span> Born :
                        </strong>
                        <span>04 Jan 1996</span>
                      </li>
                      <li>
                        <strong>
                      ...
                      <li>
                        ...
                        <span>Tamil, Telugu, English, Kannada, Hindi</span>
                      </li>
                      <li>
                        <strong>
            ...
            <div className="section-title">
              ...
              <div className="skill">
                ...
                <div
                  className="skill-cintainer"
                  style={{ backgroundColor: "rgb(0, 153, 0)", gap: "3px" }}
                >
                  PostgreSQL
                  <img src="https://cdn-icons-png.flaticon.com/512/5968/5968342.png" color="#171515" width={"30px"} />
                </div>
                <div
                  className="skill-cintainer"
                  style={{ backgroundColor: "white", gap: "3px",color:"black" }}
                >
                  NEXT.js
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Nextjs-logo.svg/800px-Nextjs-logo.svg.png" color="#171515" width={"30px"} />
                </div>
              </div>
            </div>
          </div>
